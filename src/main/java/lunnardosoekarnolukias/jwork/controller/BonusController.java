...
import lunnardosoekarnolukias.jwork.BonusNotFoundException;
import lunnardosoekarnolukias.jwork.DatabaseBonus;
...
public class BonusController {
    ...
    public Bonus getBonusByReferralCode(
            @PathVariable() String referralCode) throws BonusNotFoundException {
